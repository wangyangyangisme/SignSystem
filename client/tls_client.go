...
func main() {
	...
	f,err := os.Open("C:/Users/wangyangyang/Desktop/android_debug-release.apk")
	if err != nil {
		fmt.Println(err.Error())
		return
	}
	...
	ioutil.WriteFile("C:/Users/wangyangyang/Desktop/android_debug-release-sign.apk",body,0644)
